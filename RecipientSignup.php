...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="SignupRecipient.css">
    ...
    <body>
        ...
        <div class="signup_split">
            <div class="LeftSide">
                <section class="copy">
                    <div class="slide">
                        <h1><strong>Recipient Sign Up</strong></h1>
                        <p></p>
                    </div>
                </section>
            ...
            <div class="RightSide">
                <form name="RegisterFormRecipient" action="CheckSignup.php" method="post">
                    <section class="copy">
                        <h2>Sign Up</h2>
                        <div class="Login">
                            <p>Already have an account? <a href="RecipientLogin.php"><strong>Log In</strong></a></p>
                        </div>
                    </section>
                    <br>
                    <div id="checkname">
                    ...
                    <div class="input-container-name">
                        ...
                        <input id="name" placeholder="Enter your name" type="text" name="name" value="">
                    ...
                    <div class="input-container-phone">
                        ...
                        <input id="phone" type="tel" name="phone" placeholder="05XXXXXXX" value="">
                    ...
                    <button class="signup" type="submit" onclick="return CheckRegisterResipient();">Sign Up</button>
                    <section class="legal">
                        <p><span class="small">
